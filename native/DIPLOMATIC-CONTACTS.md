...
Use **Back to contact options** to choose a different channel immediately. Before any proposal is submitted, the unused channel fee is refunded once. After discussions begin, decisions, pending counteroffers and used agenda items survive a channel switch; the new channel charges its own fee and preparation time. Ending/cancelling a contact does not refund its fee. One contact can be active at once; contacts with the same government have a shared 120-second cooldown after conclusion. A discussion expires five minutes after its scheduled start. A change of either leader or a defeated host interrupts it; war also interrupts a visit.
